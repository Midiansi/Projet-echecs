        ...
        for j in range(8):
            ...
            if case != 0: #Case non vide
                ...
                if case == 1: #Dessine un pion
                    pyxel.blt(j * 16, i * 16, 0, 0, 0, 16, 16, 11)
                elif case == 2: #Dessine un cheval
                    pyxel.blt(j * 16, i * 16, 0, 16, 0, 16, 16, 11)
                elif case == 3: #Dessine une tour
                    pyxel.blt(j * 16, i * 16, 0, 32, 0, 16, 16, 11)
                elif case == 4: #Dessine une reine
                    pyxel.blt(j * 16, i * 16, 0, 48, 0, 16, 16, 11)
                elif case == 5: #Dessine un fou
                    pyxel.blt(j * 16, i * 16, 0, 0, 16, 16, 16, 11)
                elif case == 6: #Dessine un roi
                    pyxel.blt(j * 16, i * 16, 0, 16, 16, 16, 16, 11)
