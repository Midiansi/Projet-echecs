    ...
    for i in range(8):
        for j in range(8):
            ...
            if case != 0: #Case non vide
                ...
                elif piece == 8: #dessine une damme 
...
def valide(clic: tuple, tab: list) -> list:
    ...
    global echiquier, en_passant, mouvement_precedent
    x = clic[0]
    y = clic[1]
    case = echiquier[x][y]
    en_passant = []
    ...
    if piece == "7" and couleur == "r":
        tab = [(clic[0]-1,clic[1]+1),(clic[0]-1,clic[1]-1)]
    if piece == "7" and couleur == "b":
        tab = [(clic[0]+1,clic[1]+1),(clic[0]+1,clic[1]-1)]
        ...
        if pyxel.btnp(pyxel.MOUSE_BUTTON_RIGHT):
            ...
            for case_test in tab_case_droite:
                if clic_temp == case_test:
                    ...
                    mouvement_precedent = (clic_temp[0],clic_temp[1]) #on garde le mouvement
