...
def update():
    global case_gauche, tab_case_droite, commencer, compteur_mouv, vainqueur, echiquier, jeu
                ...
                if clic_temp == case_test:
                    ...
                    if (case_droite != 0) and (case_droite[0] == "6"):
                        if case_droite[1] == "b": #Si le roi bleu est mange
                            vainqueur = "Rouge" 
                        elif case_droite[1] == "r": #Si le roi rouge est mange
                            vainqueur = "Bleu"
...
def draw():     
    if commencer == 0:
        ...
        echiquier_vide()
        pyxel.text(41, 42, f"Victoire {vainqueur}!", 0)
        pyxel.blt(40, 48, 0, 0, 32, 55, 32, 11)
        pyxel.text(48, 80, f"en {compteur_mouv//2 + 1} rounds", 0)
        pyxel.text(43, 88, "R pour rejouer", 0)
