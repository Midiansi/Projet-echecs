...
def valide(clic: tuple, tab: list) -> list:
    ...
    if piece == "1":
        ...
        for i in range(mouv):
            tab.append((clic[0]+(i*direction)+(1*direction),clic[1])) #devant
    ...
    if piece == "3":
        tab =[(clic[0],clic[1]-7), (clic[0],clic[1]-6),(clic[0],clic[1]-5),
              (clic[0],clic[1]-4), (clic[0],clic[1]-3), (clic[0],clic[1]-2),
              (clic[0],clic[1]-1),(clic[0]+1,clic[1]), (clic[0]+2,clic[1]),
              (clic[0]+3,clic[1]),(clic[0]+4,clic[1]), (clic[0]+5,clic[1]),
              (clic[0]+6,clic[1]),(clic[0]+7,clic[1]), (clic[0],clic[1]-7),
              (clic[0],clic[1]+6),(clic[0],clic[1]+5),(clic[0],clic[1]+4),
              (clic[0],clic[1]+3), (clic[0],clic[1]+2), (clic[0],clic[1]+1),
              (clic[0]-1,clic[1]), (clic[0]-2,clic[1]),(clic[0]-3,clic[1]),
              (clic[0]-4,clic[1]), (clic[0]-5,clic[1]),(clic[0]-6,clic[1]),
              (clic[0]-7,clic[1])]
    return tab
...
def collision(couleur: str, tab: list) -> list:
    ...
    for case in tab:
        if encadre(case):
            ...
            if (piece_case != 0) and (piece_case[1] == couleur):
                tab.remove(case)
        else:
            tab.remove(case)
    return tab
