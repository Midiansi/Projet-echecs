...
def valide(clic: tuple, tab: list) -> list:
    ...
    #coordonnes valides pour une tour
        ...
        if encadre(roi_droite) and case[2] == "0" and\
        ...
        if encadre(roi_gauche) and case[2] == "0" and\
    ...
    #coordonnes valides pour un roi
        ...
        if encadre(tour_gauche) and case[2] == "0" and\
           echiquier[clic[0]][clic[1]-1] == 0 and echiquier[clic[0]][clic[1]-2] == 0 and\
        ...
        if encadre(tour_droite) and case[2] == "0" and\
           echiquier[clic[0]][clic[1]+1] == 0 and echiquier[clic[0]][clic[1]+2] == 0 and\
...
def update():
    ...
    if commencer == 0: #en attente d'une selection de mode
        ...
        if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT):
            ...
            #Piece de la case precedente, rose commence
            if jeu == "dames" or (piece_gauche == 0) or (precedent[1] != piece_gauche[1]):
            ...
            for case_test in tab_case_droite:
                if clic_temp == case_test:
                    ...
                    for i in range(0, len(roque), 4): 
                        #Pour la tour
                        if case[0] == "3":
                            if echiquier[roque[i+3][0]][roque[i+3][1]+1] == roi:
                                echiquier[roque[i+3][0]][roque[i+3][1]] = f"3{case[1]}1"
                                echiquier[clic_temp[0]][clic_temp[1]] = 0
                                break 
                            elif echiquier[roque[i+3][0]][roque[i+3][1]-1] == roi:
                                echiquier[roque[i+3][0]][roque[i+3][1]] = f"3{case[1]}1"
                                echiquier[clic_temp[0]][clic_temp[1]] = 0
                                break
                        ...
                        #Pour le roi
                        if case[0] == "6":
                            if echiquier[roque[i+1][0]][roque[i+1][1]-1] == tour:
                                echiquier[roque[i+1][0]][roque[i+1][1]] = f"6{case[1]}1"
                                echiquier[clic_temp[0]][clic_temp[1]] = 0
                                break 
                            
                            elif echiquier[roque[i+1][0]][roque[i+1][1]+1] == tour:
                                echiquier[roque[i+1][0]][roque[i+1][1]] = f"6{case[1]}1"
                                echiquier[clic_temp[0]][clic_temp[1]] = 0
                                break 
